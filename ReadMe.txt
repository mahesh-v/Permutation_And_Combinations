...
Spring 2016
Short Project 5 (Permutations and combinations)
Thu, Apr 7, 2016

Ver 1.0: Initial description (Apr 7, 3:00 PM).

Due: 1:00 PM, Thu, Apr 14.
...
Implement the following algorithms discussed in class: (a) Combination(A, n, k), (b) Permute(A, n). For Permute(), implement Take 2 and Heap's algorithms, and compare their running times for n = 8..14.
b. nPk
...
Given a DAG as input (use input format used by readGraph), visit and print all topological orders of the graph.